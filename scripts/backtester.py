...
class SimpleBacktester:
    ...
    def plot(self, save_path):
        ...
        plt.plot(self.results.index, self.results['Cumulative_Gross'], label='Gross Returns', color='green')
        plt.plot(self.results.index, self.results['Cumulative_Net'], label='Net Returns', color='blue')
...
def main():
    ...
    weights = signal.div(row_sums.replace(0, 1), axis=0) # replace 0 to avoid division by zero
